...
1. Thêm email vào mục **Test Users** trong Google Cloud Console.
2. Tài khoản chạy script cần được cấp quyền:
   - **Viewer (Nguồn)**
   - **Editor (Đích)**

💡 **Mẹo:**
Có thể tạm thời đặt thư mục đích ở chế độ _“Bất kỳ ai có link đều có quyền Editor”_ để tăng tốc độ copy.
